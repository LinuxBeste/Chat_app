...
const s = StyleSheet.create({
  ...
  card: { width: "100%", maxWidth: 360, backgroundColor: "#181B22", borderRadius: 32, borderWidth: 1, borderColor: "#2A2F3A", padding: 32 },
  title: { fontSize: 20, fontWeight: "600", color: "#F0F0F0", marginBottom: 4 },
  sub: { fontSize: 14, color: "#8B8F96", marginBottom: 24 },
  input: { width: "100%", height: 44, backgroundColor: "#0E1116", borderRadius: 16, borderWidth: 1, borderColor: "#2A2F3A", paddingHorizontal: 16, color: "#F0F0F0", fontSize: 14, marginBottom: 12 },
  button: { width: "100%", height: 44, backgroundColor: "#4850BB", borderRadius: 16, justifyContent: "center", alignItems: "center", marginTop: 8 },
