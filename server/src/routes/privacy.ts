...
router.post("/blocks", authGuard, validate(blockSchema), catchAsync(async (req: Request, res: Response) => {
...
router.delete("/blocks/:userId", authGuard, catchAsync(async (req: Request, res: Response) => {
  await db
    .delete(blocks)
...
router.get("/blocks", authGuard, catchAsync(async (req: Request, res: Response) => {
  const list = await db
...
router.post("/messages/:id/read", authGuard, catchAsync(async (req: Request, res: Response) => {
  await db
    .insert(messageReads)
...
router.get("/messages/:id/reads", authGuard, catchAsync(async (req: Request, res: Response) => {
