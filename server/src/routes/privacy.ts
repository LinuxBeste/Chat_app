...
router.post("/blocks", authGuard, validate(blockSchema), async (req: Request, res: Response) => {
...
router.get("/blocks", authGuard, async (req: Request, res: Response) => {
  const list = await db
...
router.post("/messages/:id/read", authGuard, async (req: Request, res: Response) => {
  await db
    .insert(messageReads)
...
router.get("/messages/:id/reads", authGuard, async (req: Request, res: Response) => {
